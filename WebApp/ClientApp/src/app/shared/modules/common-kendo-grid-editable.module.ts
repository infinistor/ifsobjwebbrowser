...
import { CommonKendoGridEditableComponent } from "../components/kendo-grid-editable/kendo-grid-editable.component";
...
@NgModule({
		...
		declarations: [
			CommonKendoGridEditableComponent,
		],
		exports: [
			CommonKendoGridEditableComponent,
		],    
})
export class CommonKendoEditableModule {
