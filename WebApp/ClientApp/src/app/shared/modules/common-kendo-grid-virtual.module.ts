...
import { CommonKendoGridVirtualComponent } from '../components/kendo-grid-virtual/kendo-grid-virtual.component';
...
@NgModule({
	...
	declarations: [
			CommonKendoGridVirtualComponent,
	],
	exports: [
			CommonKendoGridVirtualComponent,
	],
...
export class CommonKendoVirtualModule {
